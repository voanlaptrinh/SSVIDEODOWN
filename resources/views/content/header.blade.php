            ...
            <div class="collapse navbar-collapse mobb" id="navbarSupportedContent">
                <ul class="navbar-nav {{ app()->isLocale('ar') ? 'me-auto' : 'ms-auto' }} mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <ul class="dropdown-menu show-tool shows">
                            <div class="row pe-3 ps-3">
                                <div class="col-lg-4 pt-3 text-start text-white mb-2">
                                    <a href="" class="dropdown-link my-2">
                    ...
                    <?php if(isset($controller->supportedLanguages)){ ?>
                        <li class="nav-item dropdown ">
                            <a class="btn btn-light dropdown-toggle text-black drop-hover w-100" href="#"
